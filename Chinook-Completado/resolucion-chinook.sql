...
-- 8
-- IMPORTANTE
SELECT e.LastName AS "Apellido del Empleado", e.Title AS "Puesto del Empleado", em.LastName AS "Apellido de su Jefe", COUNT(c.CustomerId) AS "Cantidad de Clientes que atendió"
FROM employees e
